...
import SortIcon from './components/Sort.vue';
...
<template>
    <div class="w-full preferFontSize">
        ...
        <main class="p-3">
            ...
            <div
                v-show="addingMode"
                class="flex flex-col gap-2 bg-slate-100 p-3"
            >
                <div>
                    Section:
                ...
                <div>
                    ...
                    >
                        ...
                        />[Project Coordinator] {{ member.projectCo }} Student
                        Id:
                        <input
        ...
        <!--3. Paginate -->
        <section class="sticky bottom-0 bg-purple-200 w-full">
            <div class="flex justify-center gap-2 pt-2">
                <p
                    @click="getRows(n)"
                    v-for="(n, index) in getLastPage(groups, rowsPerPage)"
                    :key="index"
                    :class="currentPage !== n ? '' : 'bg-blue-400'"
